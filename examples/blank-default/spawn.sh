...
# This script can be used to create the blank-default.git example repository.

set -e

HOME_DIR="/var/lib/blank"
REPO_PATH="${HOME_DIR}/repos/alice/blank-default.git"
...
unset GIT_DIR
unset GIT_WORK_TREE
nix-prefetch-git --quiet --leave-dotGit ${REPO_PATH} > ../blank-default.json
